...
function renderExperience(d){
  ...
  $('moveMetrics').innerHTML=metrics&&Object.keys(metrics).length?metricRow('Relevance',metrics.relevance)+metricRow('Confidence',metrics.confidence)+metricRow('Executability',metrics.executability)+metricRow('Strategic fit',metrics.strategic_fit)+metricRow('Risk safety',metrics.risk,true)+metricRow('Capital efficiency',metrics.capital_burden,true):'<div class="empty-copy">No scored move currently selected.</div>';
